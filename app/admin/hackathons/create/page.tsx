...
export default function CreateHackathonPage() {
  ...
  const [submissionDeadline, setSubmissionDeadline] = useState(new Date(Date.now() + 30 * 24 * 60 * 60 * 1000))
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    // In a real app, you would submit the form data to create a new hackathon
    console.log({
      title,
      description,
      startDate,
    ...
    // Redirect to the hackathons list page
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight">Create Hackathon</h2>
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Enter the basic details for the hackathon</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set the start and end dates for the hackathon</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Specify the types of media that participants can submit</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Select teachers who will be responsible for this hackathon</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Configure additional settings for the hackathon</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2 pt-2">
                <Checkbox id="auto-publish-results" />
            ...
            <CardFooter className="flex justify-between">
              <Button variant="outline" type="button" asChild>
                <Link href="/admin/hackathons">Cancel</Link>
              </Button>
